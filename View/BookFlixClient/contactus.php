    ...
    <header class="position-absolute w-100 " style="background-color: black; ">
        ...
        <div class="container">
            ...
            <nav class="navbar navbar-expand-md navbar-light">
                <a class="navbar-brand" href="index.html"><img src="assets/images/LOGO4.png" alt="Multipurpose"></a>
            ...
            <div class="row justify-content-center mt-5">
                <div class="col-lg-7 mt-5">
                    <div class="section-title position-relative text-center mb-5 pb-2 wow fadeInUp mt-5" data-wow-delay="0.1s">
                        <h6 class="position-relative d-inline text-primary ps-4 mt-5"data-aos="fade-right" data-aos-delay="200">Contact Us</h6>
                        <h2 class="mt-2" data-aos="fade-right" data-aos-delay="600">Contact For Any Query</h2>
                    </div>
                    <div class="wow fadeInUp" data-wow-delay="0.3s">
                        <form action="send.php" method="post">
                            <div class="row g-3" data-aos="fade-left" data-aos-delay="600">
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <input type="email" class="form-control" name="email" id="email" value="" placeholder="Your Email" style="color:black;">
                                ...
                                <div class="col-12">
                                    <div class="form-floating">
                                        <textarea class="form-control" name="message" placeholder="Leave a message here" id="message" style="height: 150px ;color:black;"></textarea>
                                        <label for="message">Message</label>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <button class="custom-btn btn-primary w-100 py-3" name="send" type="submit">Send Message</button>
                                </div>
                            </div>
                        </form>
                    </div>
