...
<main>
    ...
    <div class="container-xxl py-5 pt-5 height-container">
        <div class="container px-lg-5 pt-5 mt-5 ">
            <div class="section-title position-relative text-center mb-5 pb-2 wow fadeInUp pt-5 mt-5 " data-wow-delay="0.1s">
                <h6 class="position-relative d-inline text-primary ps-4 pt-5 mt-5 "data-aos="fade-right" data-aos-delay="400">Our Services</h6>
                <h2 class="mt-2 "data-aos="fade-left" data-aos-delay="600">What Solutions We Provide</h2>
            </div>
            <div class="row g-4 pt-5">
                <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.1s"data-aos="fade-up" data-aos-delay="600">
                    <div class="service-item d-flex flex-column justify-content-center text-center rounded">
                        <div class="service-icon flex-shrink-0">
                            <i class="fa fa-home fa-2x"></i>
                        </div>
                        <h5 class="mb-3">Online shopping</h5>
                        <p>The website provides a platform for customers to browse and purchase books, movies, and cosplay items online.</p>
                        <a class="custom-btn px-3 mt-auto mx-auto" href="">Read More</a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.3s"data-aos="fade-up" data-aos-delay="600">
                    <div class="service-item d-flex flex-column justify-content-center text-center rounded">
                        <div class="service-icon flex-shrink-0">
                            <i class="fa fa-home fa-2x"></i>
                        </div>
                        <h5 class="mb-3">Vast collection</h5>
                        <p>The website offers a vast collection of books and movies from different genres, catering to all ages and tastes</p>
                        <a class="custom-btn px-3 mt-auto mx-auto" href="">Read More</a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.6s"data-aos="fade-up" data-aos-delay="600">
                    <div class="service-item d-flex flex-column justify-content-center text-center rounded">
                        <div class="service-icon flex-shrink-0">
                            <i class="fa fa-home fa-2x"></i>
                        </div>
                        <h5 class="mb-3">Regular updates</h5>
                        <p> The inventory is regularly updated to keep up with the latest releases, ensuring that customers always find something new and exciting to add to their collection.</p>
                        <a class="custom-btn px-3 mt-auto mx-auto" href="">Read More</a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.1s"data-aos="fade-up" data-aos-delay="600">
                    <div class="service-item d-flex flex-column justify-content-center text-center rounded">
                        ...
                        <h5 class="mb-3">Cosplay costumes and accessories</h5>
                        <p>The website offers a range of cosplay costumes, accessories, and props, perfect for bringing favorite characters to life.</p>
                        <a class="custom-btn px-3 mt-auto mx-auto" href="">Read More</a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.3s"data-aos="fade-up" data-aos-delay="600">
                    <div class="service-item d-flex flex-column justify-content-center text-center rounded">
                        ...
                        <h5 class="mb-3">Competitive prices</h5>
                        <p>The website is committed to providing high-quality products at competitive prices, ensuring that customers get the best value for their money.</p>
                        <a class="custom-btn px-3 mt-auto mx-auto" href="">Read More</a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.6s"data-aos="fade-up" data-aos-delay="600">
                    <div class="service-item d-flex flex-column justify-content-center text-center rounded">
                        ...
                        <h5 class="mb-3">Excellent customer service</h5>
                        <p> The website provides excellent customer service to ensure that customers have a fantastic shopping experience</p>
                        <a class="custom-btn px-3 mt-auto mx-auto" href="">Read More</a>
                    </div>
                </div>
            </div>
...
<footer class="">
    <!-- Widgets Start -->
    <div class="footer-widgets  "style="margin-top:-150px">
        <div class="container">
            <div class="row">
