...
if(isset($_POST['addcart']))
  {
    if (!empty($_SESSION['idUser']))
    {
       ...
       $_SESSION['idproduct']=$_GET['product-id'];
          ...
          <div class = "product-content"data-aos="fade-up" data-aos-delay="400">
            ...
            <div class = "purchase-info"data-aos="fade-right" data-aos-delay="600">
                   <form action="" method="post">
                       <input type = "number" min = "0" max="<?php echo $quantity ;?>" value = "1">
                      <button type = "submit" class = "filter-btn product-details-btn  " name="addcart">
