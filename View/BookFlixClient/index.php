...
if(isset($_POST['update']))
{
    ...
    $phone=$_POST['phone'];
    $update=new User('',$username,$password,'',$phone,'');
    CrudUser::Update($update,$_SESSION['idUser']);
}
?>
<!doctype html>
<html lang="en">
        ...
        <div class="container">
            ...
            <div class="top-header d-none d-sm-flex justify-content-between align-items-center">
                <div class="contact">
                    ...
                    <a href="mailto:info@yourmail.com"><i class="fa fa-envelope" aria-hidden="true"></i><?php if (isset($_GET['code'])) {
                                                                                                            echo $try['email'];
                                                                                                        } else echo $_SESSION['idUser']; ?></a>
                </div>
            ...
            <nav class="navbar navbar-expand-md navbar-light">
                ...
                <div class="group d-flex align-items-center mx-2 px-4">
                    ...
                    <a href="#" class="settings-link mx-4"><i class="fa fa-cog"></i> </a>
                    <div class="popup" >
                        <button type="button" class="btn-close close-icon" aria-label="Close"><i class="fas fa-times"></i></button>
                        <form method="post">
                            <div class="mb-3">
                                <label for="username" class="form-label"  style="color:black; border:none; outline:none;">Username:</label>
                                <input type="text" class="form-control" id="username" name="username" style="color:black; border:none; outline:none;">
                            </div>
                            <div class="mb-3">
                                <label for="password" class="form-label"  style="color:black; border:none; outline:none;">Password:</label>
                                <input type="password" class="form-control" id="password" name="password" style="color:black; border:none; outline:none;">
                            </div>
                            <div class="mb-3">
                                <label for="phone" class="form-label"  style="color:black; border:none; outline:none;">Phone number:</label>
                                <input type="tel" class="form-control" id="phone" name="phone" style="color:black; border:none; outline:none;">
                            </div>
                            <button type="submit" name="update" class="btn btn-primary save-btn">Save Changes</button>
