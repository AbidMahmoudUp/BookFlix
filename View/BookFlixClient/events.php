...
<body>
   ...
   <main class="shop-main">
    <div class="shop-header" style="margin: 30px;" data-aos="fade-left" data-aos-delay="500">
                <h1 class="event-title">Lasted Events</h1>
     </div>
   <div class="container">
        ...
        <?php foreach ($events as $event): ?>
            ...
            <div class="body-container">
                ...
                <div class="event-info">
                    <p class="title"><?php echo $event["nomevent"]; ?></p>
                    <div class="separator"></div>
                    <p class="info"><?php echo $event["localisation"]; ?></p>
                    <p class="price"><?php echo $event["prix"]; ?></p>

                    <div class="additional-info">
                        <p class="info">
                            <i class="far fa-calendar-alt"></i>
                            <?php echo $event["dateheure"]; ?>
                        </p>
                ...
                <a href="event-details.php?eventid=<?php echo $event["idevent"]; ?>"class="action" style="color:white;">Book it</a>
            </div>
        </div>
        <?php endforeach; ?> 
    </div>
