			...
			<main class="content ">
				<div class="d-flex align-items-center justify-content-between mb-3" >
					 <div class="input-group" style="width: 300px !important;">
					   <form action="" method="post"  class="input-group" style="width: 300px !important;height:fit-content;">
					 ...
					 <div id="popup-container-Admin" class="popup-container-Admin" style="width: 28%;">
						...
						<div id="popup-content-Admin" class="" style="max-height: 570px;">				
                            ...
                            <form method="post" action="">
                               ...
                               <input type="number" placeholder="" id="codepostal" name="codepostal" required oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength="4">

                               <label for="pays">Pays:</label>
                               <input type="text" placeholder="" id="pays" name="pays" required>

                               <div class="d-flex align-items-center justify-content-between mb-3  ">
									<a href="livraison.php" class="btn btn-secondary btn-block mt-3" style="border-radius: 5px;">Cancel</a>
                                ...
                                <table class="table table-striped table-hover ">
                                  ...
                                  <tbody>
					                 <?php foreach($liste as $row){?>
                                      <tr>
                                    		<td   >
                                    			<span class="badge bg-danger" ><?php echo $row["idlivraison"];  ?></span>
                                    		</td>
                                         <td><?php echo $row['idcommande']; ?></td>
                                          ...
                                          <td>
                                    			 <a href="livraison.php?update=<?= $row["idlivraison"]; ?>" style="margin:10px;" class="btn btn-primary open-popup-ElseWhere" name="modify" id="update-button">Modify</a>
                                    			 <a href="livraison.php?delete=<?= $row["idlivraison"]; ?>" style="margin: 10px;" class="btn btn-danger" name="delete">Delete</a>
                                    	  </td>
                                      </tr>
                                     <?php }?>      
                                  </tbody>
